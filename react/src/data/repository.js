...
// ---------- Fianl Results --------------------------------------------
async function createFinalResults(studentID, studentName, studentGroup, studentGender, fathersName, mothersName, parentEmail, studentEmail, attendanceResult) {
  const response = await axios.post(API_HOST + "/MAApi/finalResults", { studentID, studentName, studentGroup, studentGender, fathersName, mothersName, parentEmail, studentEmail, attendanceResult }, getHeaders());
