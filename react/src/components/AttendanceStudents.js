...
function Attendance(props) {
    ...
    const handleAttendanceChange = async (studentId, status, studentGroup) => {
        ...
        if (existingFinalResults)
            ...
            await createFinalResults(studentId, student?.name, student?.group, student?.gender, student?.fathersName, student?.mothersName, student?.fathersEmail, student?.studentEmail, presentMark);
