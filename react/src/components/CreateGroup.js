            ...
            <div className="container mt-5">
                <div className="row justify-content-center">
                    <div className="col-md-6 mt-custom">
                        <div className="card">
                            <h5 className="card-header card text-white bg-info">Create a New Group</h5>
                            <div className="card-body text-center">
                                ...
                                <form onSubmit={handleSubmit} noValidate>
                                    ...
                                    <button type="submit" className="btn btn-primary" style={{ margin: "10px", textAlign: "center" }}>Create Group</button>
